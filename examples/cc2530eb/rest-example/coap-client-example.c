...
#define PRINT6ADDR(addr) PRINTF("%02x", ((uint8_t *)addr)[0]);   \
    	PRINTF("%02x", ((uint8_t *)addr)[1]); \
	PRINTF(":"); \
	PRINTF("%02x", ((uint8_t *)addr)[2]); \
    	PRINTF("%02x", ((uint8_t *)addr)[3]); \
	PRINTF(":"); \
	PRINTF("%02x", ((uint8_t *)addr)[4]); \
    	PRINTF("%02x", ((uint8_t *)addr)[5]); \
	PRINTF(":"); \
	PRINTF("%02x", ((uint8_t *)addr)[6]); \
    	PRINTF("%02x", ((uint8_t *)addr)[7]); \
	PRINTF(":"); \
	PRINTF("%02x", ((uint8_t *)addr)[8]); \
    	PRINTF("%02x", ((uint8_t *)addr)[9]); \
	PRINTF(":"); \
	PRINTF("%02x", ((uint8_t *)addr)[10]); \
    	PRINTF("%02x", ((uint8_t *)addr)[11]); \
	PRINTF(":"); \
	PRINTF("%02x", ((uint8_t *)addr)[12]); \
    	PRINTF("%02x", ((uint8_t *)addr)[13]); \
	PRINTF(":"); \
	PRINTF("%02x", ((uint8_t *)addr)[14]); \
...
send_data(void)
{
  ...
  if (init_buffer(COAP_DATA_BUFF_SIZE)) {
    ...
    PRINTF("]:%u/%s\n\r", (uint16_t)REMOTE_PORT, service_urls[service_id]);
